...
// import { ICreateDepartement, ICreateUtilisateur, IPagination, IUpdateUtilisateur, IUtilisateur } from '../types/interfaces';
...
//   static async createUtilisateur(utilisateur: ICreateUtilisateur): Promise<IUtilisateur> {
//     const response = await AXIOS_INSTANCE.post(`/utilisateurs`, utilisateur);
//     return response.data;
//   }
//   static async updateUtilisateur(id: String, utilisateur: IUpdateUtilisateur): Promise<IUtilisateur> {
//     const response = await AXIOS_INSTANCE.patch(`/utilisateurs/${id}`, utilisateur);
//     return response.data;
//   }
